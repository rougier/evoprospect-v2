...
# FIGURE 3 : PT PARAMETERS ~ ELO PLOTS
# Display plots of PT parameters with Elo score. Each point represent a Pt parameters during a particular 1500 trial period for an individual
...
ggplot(filtered_data, aes(x = elo, y = rho_g)) +
  ...
  geom_point(size = 0.75, aes(group = monkey)) +
  stat_smooth(method = "lm", formula = y ~ poly(x, 2), color = "skyblue", size = 2) +
  labs(title = "", 
       x = "Elo score", 
...
ggplot(filtered_data, aes(x = elo, y = rho_l)) +
  geom_hline(yintercept = 0, color = "black", linewidth = 0.8) +
  geom_point(size = 0.75, aes(group = monkey)) +
  stat_smooth(method = "lm", formula = y ~ poly(x, 2), color = "orange", linetype = "dashed", size = 1) +   
  labs(title = "", 
       x = "Elo score", 
...
ggplot(filtered_data, aes(x = elo, y = alpha_lraw)) +
  geom_hline(yintercept = 1, color = "black", linewidth = 0.8) +
  geom_point(size = 0.75, aes(group = monkey)) +
  stat_smooth(method = "lm", formula = y ~ x, color = "orange", linetype = "dashed", size = 1) +
  labs(title = "", 
       x = "Elo score", 
...
ggplot(filtered_data, aes(x = elo, y = lambdaraw)) +
  geom_hline(yintercept = 1, color = "black", linewidth = 0.8) +
  geom_point(size = 0.75, aes(group = monkey)) +
  stat_smooth(method = "lm", formula = y ~ poly(x, 2), color = "#D62728", size = 2) +
  labs(title = "", 
       x = "Elo score", 
...
ggplot(filtered_data, aes(x = elo, y = COP)) +
  geom_point(size = 0.75, aes(group = monkey)) + 
  geom_smooth(method = "lm", formula = y ~ poly(x, 2), color = "#2CA02C", linewidth = 2) +
  labs(
    title = "",
    x = "Elo score",
