...
`fig4.Rmd` : This script display predictive values and intervale confidence of Pt parameters function of Elo score, trial number, COP and Certainty from LMM models.
